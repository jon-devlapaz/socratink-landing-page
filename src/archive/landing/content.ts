/**
 * Copy for archived landing pieces. Homepage must not import this module.
 */
  ...
  stages: [
    {
      id: "day-01",
      day: "Day 01",
      stage: "First attempt from memory",
...
export const faq = {
  ...
  items: [
    ...
    {
      id: "time",
      question: "How does Socratink help me practice hard material?",
      answer:
        "Start with a concept from your syllabus, explain it in your own words, and use the feedback to see what holds up and what needs more work. Return to the idea later and try again without help.",
    },
    {
      id: "privacy",
      question: "Does Socratink use my thinking to train public models?",
      answer:
        "Never. Your transcripts, practice attempts, and receipts are stored locally on your device and belong strictly to you. You can export your entire ledger anytime as Markdown, JSON, or an Anki deck, or wipe it with one click. We never sell user data or train public foundation models on learner reasoning.",
    },
  ],
} as const;
